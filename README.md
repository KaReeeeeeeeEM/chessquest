...
The current release supports Android, macOS, Windows, and Linux.
...
| --- | --- | --- |
| Native application | Tauri 2 + Rust | Android, macOS, Windows, and Linux packaging and notifications |
